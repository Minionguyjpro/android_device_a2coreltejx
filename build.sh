...
git clone https://github.com/Minionnguyjpro/android_device_samsung_a2corelte --depth 1 -b lineage-21.0 device/samsung/a2corelte; \
...
git clone https://github.com/Minionguyjpro/android_vendor_samsung_a2corelte --depth 1 -b lineage-21.0 vendor/samsung/a2corelte; \
