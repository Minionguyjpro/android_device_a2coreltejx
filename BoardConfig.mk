...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100 --board SRPSB21A012RU --dtb device/samsung/a2corelte/prebuilt/dtb.img
...
TARGET_PREBUILT_KERNEL := device/samsung/a2corelte/prebuilt/Image.gz
